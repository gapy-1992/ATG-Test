...
'step 5: At Page_test-planning click on hyperlink_menu_visual_testing --> navigate to Page_katalon-eyes'

testObj = findTestObject('Object Repository/Page_team_project_test-planning/hyperlink_object_17')
...
'step 6: At Page_katalon-eyes click on hyperlink_baseline_collection --> navigate to Page_baseline-collection'
...
'step 7: At Page_baseline-collection click on button_create_baseline_collection'

testObj = findTestObject('Object Repository/Page_team_project_baseline-collection/button_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/baseline-collection(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 8: Add visual checkpoint at Page_baseline-collection'
