...
'step 8: At Page_test-project click on hyperlink_test_project'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_7')
...
'step 9: Add visual checkpoint at Page_test-project'
