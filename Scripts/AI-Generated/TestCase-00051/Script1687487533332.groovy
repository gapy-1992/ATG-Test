...
'step 8: At Page_test-project click on div_object'

testObj = findTestObject('Object Repository/Page_team_project_test-project/div_object_14')
...
'step 9: At Page_test-project click on button_select_organization'

testObj = findTestObject('Object Repository/Page_team_project_test-project/button_object_3')
...
'step 10: Add visual checkpoint at Page_test-project'
