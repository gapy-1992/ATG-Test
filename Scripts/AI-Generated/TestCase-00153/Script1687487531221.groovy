...
'step 9: At Page_integrations click on hyperlink_testcloudtunnel --> navigate to Page_testCloudTunnel'

testObj = findTestObject('Object Repository/Page_team_project_integrations/hyperlink_object_1')
