...
'step 6: At Page_test-design_test-suites click on hyperlink_test_planning --> navigate to Page_test-planning'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-suites/hyperlink_object')
...
'step 9: Add visual checkpoint at Page_test-reports_test-design_requirement-test-run-coverage'
