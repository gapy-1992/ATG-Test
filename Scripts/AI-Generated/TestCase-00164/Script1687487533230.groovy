...
'step 5: At Page_test-project click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_10')
...
'step 6: At Page_test-environment-installation click on hyperlink_agent --> navigate to Page_agent'

testObj = findTestObject('Object Repository/Page_team_project_test-environment-installation/hyperlink_object_11')
...
'step 7: At Page_agent click on hyperlink_test_planning --> navigate to Page_test-planning'

testObj = findTestObject('Object Repository/Page_team_project_agent/hyperlink_object_12')
...
'step 8: At Page_test-planning click on hyperlink_test_design_test_cases --> navigate to Page_test-design_test-cases'

testObj = findTestObject('Object Repository/Page_team_project_test-planning/hyperlink_object_15')
...
'step 9: At Page_test-design_test-cases click on hyperlink_releases --> navigate to Page_releases'
...
'step 10: At Page_releases click on hyperlink_project --> navigate to Page_project'
...
'step 11: Add visual checkpoint at Page_project'
