...
'step 5: At Page_integrations click on hyperlink_agent --> navigate to Page_agent'

testObj = findTestObject('Object Repository/Page_team_project_integrations/hyperlink_object_5')
...
'step 6: At Page_agent click on hyperlink_agent_k8s --> navigate to Page_agent_k8s'
...
'step 7: At Page_agent_k8s click on hyperlink_agent_circle_ci --> navigate to Page_agent_circle-ci'
...
'step 8: At Page_agent_circle-ci click on hyperlink_agent_test_cloud --> navigate to Page_agent_test-cloud'

testObj = findTestObject('Object Repository/Page_team_project_agent_circle-ci/hyperlink_object_1')
...
'step 9: Add visual checkpoint at Page_agent_test-cloud'
