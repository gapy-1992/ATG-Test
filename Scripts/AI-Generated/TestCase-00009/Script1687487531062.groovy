...
'step 5: At Page_test-planning click on button_open_schedule_dialog'

testObj = findTestObject('Object Repository/Page_team_project_test-planning/button_object')
