...
'step 7: At Page_test-project click on hyperlink_test_project'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_18')
...
'step 8: At Page_test-project click on hyperlink_releases --> navigate to Page_releases'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_21')
...
'step 9: At Page_releases click on hyperlink_create_release --> navigate to Page_releases_create'
...
'step 10: Add visual checkpoint at Page_releases_create'
