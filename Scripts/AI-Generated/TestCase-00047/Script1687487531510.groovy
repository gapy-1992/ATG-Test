...
'step 6: At Page_grid click on hyperlink_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_grid/hyperlink_object_1')
