...
'step 3: At Page_home click on button_select_organization'
...
'step 4: At Page_home click on hyperlink_project --> navigate to Page_project'

testObj = findTestObject('Object Repository/Page_organization_home/hyperlink_object_31')
...
'step 5: At Page_project click on hyperlink_menu_reports --> navigate to Page_overview'
...
'step 6: At Page_overview click on hyperlink_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_overview/hyperlink_object_12')
...
'step 7: At Page_test-project click on hyperlink_integrations --> navigate to Page_integrations'
...
'step 8: At Page_integrations click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'

testObj = findTestObject('Object Repository/Page_team_project_integrations/hyperlink_object_3')
...
'step 9: Add visual checkpoint at Page_test-environment-installation'
