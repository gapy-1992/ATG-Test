...
testObj = findTestObject('Object Repository/Page_team_project/hyperlink_object_18')
...
'step 5: At Page_releases click on hyperlink_executions --> navigate to Page_executions'

testObj = findTestObject('Object Repository/Page_team_project_releases/hyperlink_object_17')
...
'step 6: At Page_executions click on hyperlink_plans --> navigate to Page_plans'

testObj = findTestObject('Object Repository/Page_team_project_releases_executions/hyperlink_object_3')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/releases/.*/executions(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: Add visual checkpoint at Page_plans'
