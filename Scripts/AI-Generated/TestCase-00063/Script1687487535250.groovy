...
'step 5: At Page_releases click on hyperlink_autonomous_user_journeys --> navigate to Page_autonomous_user-journeys'
...
'step 6: At Page_autonomous_user-journeys click on hyperlink_test_design_test_cases --> navigate to Page_test-design_test-cases'

testObj = findTestObject('Object Repository/Page_team_project_autonomous_user-journeys/hyperlink_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/autonomous/user-journeys(?:#.*)?(?:\\?.*)?$', true)
...
'step 8: At Page_test-design_test-cases click on div_root_206211'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-cases/div_object_1')
...
'step 10: Add visual checkpoint at Page_releases'
