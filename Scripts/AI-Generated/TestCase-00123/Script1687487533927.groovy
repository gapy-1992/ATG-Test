...
'step 6: At Page_requirements click on hyperlink_test_reports_test_design_requirement_tes --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'
...
'step 7: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_overview --> navigate to Page_overview'

testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-design_requirement-test-run-coverage/hyperlink_object')
...
'step 8: At Page_overview click on div_object'
...
'step 9: At Page_overview click on hyperlink_failed_test_result --> navigate to Page_failed-test-result'
...
'step 10: Add visual checkpoint at Page_failed-test-result'
