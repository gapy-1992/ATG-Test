...
'step 5: At Page_test-design_test-cases click on hyperlink_test_design_test_suites --> navigate to Page_test-design_test-suites'
...
'step 6: At Page_test-design_test-suites click on hyperlink_test_design_test_objects --> navigate to Page_test-design_test-objects'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-suites/hyperlink_object_9')
...
'step 7: At Page_test-design_test-objects click on hyperlink_test_design_test_cases --> navigate to Page_test-design_test-cases'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-objects/hyperlink_object')
...
'step 8: At Page_test-design_test-cases click on div_root_uploaded_data'
...
'step 9: At Page_test-design_test-cases click on hyperlink_'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-cases/hyperlink_object_12')
...
'step 11: At Page_test-project click on hyperlink_agent --> navigate to Page_agent'
...
'step 12: At Page_agent click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'
...
'step 13: At Page_test-environment-installation click on button_object'

testObj = findTestObject('Object Repository/Page_team_project_test-environment-installation/button_object')
...
'step 14: At Page_test-environment-installation click on hyperlink_integrations --> navigate to Page_integrations'
...
'step 15: Add visual checkpoint at Page_integrations'
